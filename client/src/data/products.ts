...
export const products: Product[] = [
  {
    slug: "accfino",
    name: "AccFino",
    category: "Accounting & Finance · SME Platform",
    emoji: "🧾",
    logo: "/img/products/accfino.png?v=10",
    logoScale: 1.30,
    tagline: "Accounting that thinks ahead of your books",
    summary:
      "An AI-native Accounting and Finance platform built for small and medium enterprises (SME) — reconciliation, cash-flow forecasting, capital gains and smart lending analysis in one login.",
    description: [
      "AccFino is an Accounting and Finance platform purpose-built for small and medium enterprises (SME): AI bank reconciliation, ML cash-flow forecasting, crypto and equity CGT reporting, open banking feeds, and a smart lending readiness engine in a single platform for SMEs and the accountants who serve them.",
  ...
  },
  {
    ...
    summary:
      "Six purpose-built modules in one platform — two for individual job seekers, four for businesses hiring — covering resume analysis, job matching, market intelligence, LinkedIn sourcing, JD creation and candidate evaluation.",
    description: [
      "TalentIQ splits its capabilities by who's using them. For individuals: CVAnalysis reviews and scores a resume against real job requirements, and Jobhunter searches and matches live roles to that profile. For businesses: MarketIntel surfaces live salary and demand data, Linkexplore sources LinkedIn candidates at scale, JD Creator drafts structured job descriptions, and Candidatelens gives recruiters a detailed, structured read on any individual candidate.",
      "The underlying matching and scoring logic deliberately avoids asking an LLM for a match score directly — it extracts structured facts from resumes and job ads via Groq, then computes scores with plain deterministic Python, so formatting drift in a model response can never silently corrupt a candidate's score.",
    ...
    stats: [
      ...
      { value: "Live", label: "Market data, not a snapshot" },
      { value: "5", label: "ATS-weighted scoring factors" },
    ],
    features: [
      { title: "CVAnalysis", detail: "For individuals — reviews a resume against real job requirements, scoring strengths and gaps and producing a structured skills-and-experience profile for matching." },
      { title: "Jobhunter", detail: "For individuals — searches live job listings and matches them against a candidate's profile, surfacing the roles worth applying to." },
      { title: "MarketIntel", detail: "For businesses — live salary, demand and skills-gap intelligence drawn from current market data, not a stale snapshot." },
      { title: "Linkexplore", detail: "For businesses — searches and sources LinkedIn candidate profiles at scale against a role's requirements." },
      { title: "JD Creator", detail: "For businesses — drafts structured, consistent job descriptions from a few input details, speeding up how fast a role gets posted." },
      { title: "Candidatelens", detail: "For businesses — a detailed, structured view into an individual candidate's skills, experience and fit for a specific role." },
    ],
    technical: [
      {
